...
#define CUSTOM_MACHINE_NAME "Muramic"
...
#define _CERAMIC_DUMMY_TEMP 42
#define DUMMY_THERMISTOR_998_VALUE _CERAMIC_DUMMY_TEMP
...
#define HEATER_0_MINTEMP _CERAMIC_DUMMY_TEMP
#define HEATER_1_MINTEMP _CERAMIC_DUMMY_TEMP
...
#define HEATER_0_MAXTEMP _CERAMIC_DUMMY_TEMP
#define HEATER_1_MAXTEMP _CERAMIC_DUMMY_TEMP
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 252.0 // mm

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 173.0 // mm

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 29.0 // mm
...
#define DEFAULT_MAX_FEEDRATE          {23, 23, 23, 25}    // (mm/sec)
